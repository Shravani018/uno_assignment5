...
python train_rl.py
# For convenience, a pretrained model (rl_model.pt) is already included in the folder
...
(https://www.researchgate.net/publication/254060888_Information_Set_Monte_Carlo_Tree_Search)
