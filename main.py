...
# print("\n=== 8. RL vs MCTS ===")
# run_self_play(rl,MCTSAgent("MCTS"),num_games=max,save_logs=False,save_dataset=False,base_seed=0,)

# print("\n=== 9. MCTS vs Random ===")
# run_self_play(MCTSAgent("MCTS"),RandomAgent("Random"),
#               num_games=10_000,save_logs=False,save_dataset=False,base_seed=0,)
...
# print("\n=== 11. Rule vs MCTS ===")
# run_self_play(RuleAgent("RuleGood"),MCTSAgent("MCTS"),
#     num_games=10_000,save_logs=False,save_dataset=False,base_seed=0,)



print("\n=== 11. RuleBad vs Random ===")
run_self_play(RuleBadAgent("RuleBad"),RandomAgent("Random"),
    num_games=10_000,save_logs=False,save_dataset=False,base_seed=0,)


print("\n=== 11. Rule vs MCTS ===")
run_self_play(RandomAgent("Random"),RuleBadAgent("RuleBad"),
    num_games=10_000,save_logs=False,save_dataset=False,base_seed=0,)