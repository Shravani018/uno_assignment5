...
run_self_play(RandomAgent("Random-A"), RandomAgent("Random-B"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)
...
run_self_play(RuleBadAgent("Rule-Bad"), RandomAgent("Random"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 8. Random vs Anti-Rule ===")
run_self_play(RandomAgent("Random"), RuleBadAgent("Rule-Bad"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)
...
print("\n=== 9. Random vs RL ===")
run_self_play(RandomAgent("Random"), rl,
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 10. RL vs Random ===")
run_self_play(rl, RandomAgent("Random"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 11. Rule vs RL ===")
run_self_play(RuleAgent("Rule"), rl,
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 12. RL vs Rule ===")
run_self_play(rl, RuleAgent("Rule"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 13. MCTS vs Random ===")
run_self_play(MCTSAgent("MCTS"), RandomAgent("Random"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)

print("\n=== 14. Random vs MCTS ===")
run_self_play(RandomAgent("Random"), MCTSAgent("MCTS"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 15. MCTS vs Rule ===")
run_self_play(MCTSAgent("MCTS"), RuleAgent("Rule"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 16. Rule vs MCTS ===")
run_self_play(RuleAgent("Rule"), MCTSAgent("MCTS"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 17. MCTS vs RL ===")
run_self_play(MCTSAgent("MCTS"), rl,
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)


print("\n=== 18. RL vs MCTS ===")
run_self_play(rl, MCTSAgent("MCTS"),
              num_games=num_games, save_logs=False, save_dataset=False, base_seed=0,)